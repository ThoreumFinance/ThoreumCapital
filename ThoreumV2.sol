...
contract BusdDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("THOREUM_BUSD_Dividend_Tracker", "THOREUM_BUSD_Dividend_Tracker", 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56) {
...
contract ThoreumV2 is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0x8Ad9CB111d886dBAbBbf232c9A1339B13cB168F8;
    address public treasuryWallet = 0x312874C97CdD918Fa45cd3A3625E012037850EBE;
    ...
    constructor() ERC20("Thoreum V2 (Thoreum Multi-chain Venture Capital)", "THOREUM") {
    ...
    function setBusdDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newBusdDividendTracker.owner() == address(this), "must be owned by Thoreum");
